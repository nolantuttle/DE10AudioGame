...
`timescale 1 ps / 1 ps
module pio_mm_interconnect_0 (
		input  wire [11:0] hps_1_h2f_lw_axi_master_awid,                                        //                                       hps_1_h2f_lw_axi_master.awid
		input  wire [20:0] hps_1_h2f_lw_axi_master_awaddr,                                      //                                                              .awaddr
		input  wire [3:0]  hps_1_h2f_lw_axi_master_awlen,                                       //                                                              .awlen
		input  wire [2:0]  hps_1_h2f_lw_axi_master_awsize,                                      //                                                              .awsize
		input  wire [1:0]  hps_1_h2f_lw_axi_master_awburst,                                     //                                                              .awburst
		input  wire [1:0]  hps_1_h2f_lw_axi_master_awlock,                                      //                                                              .awlock
		input  wire [3:0]  hps_1_h2f_lw_axi_master_awcache,                                     //                                                              .awcache
		input  wire [2:0]  hps_1_h2f_lw_axi_master_awprot,                                      //                                                              .awprot
		input  wire        hps_1_h2f_lw_axi_master_awvalid,                                     //                                                              .awvalid
		output wire        hps_1_h2f_lw_axi_master_awready,                                     //                                                              .awready
		input  wire [11:0] hps_1_h2f_lw_axi_master_wid,                                         //                                                              .wid
		input  wire [31:0] hps_1_h2f_lw_axi_master_wdata,                                       //                                                              .wdata
		input  wire [3:0]  hps_1_h2f_lw_axi_master_wstrb,                                       //                                                              .wstrb
		input  wire        hps_1_h2f_lw_axi_master_wlast,                                       //                                                              .wlast
		input  wire        hps_1_h2f_lw_axi_master_wvalid,                                      //                                                              .wvalid
		output wire        hps_1_h2f_lw_axi_master_wready,                                      //                                                              .wready
		output wire [11:0] hps_1_h2f_lw_axi_master_bid,                                         //                                                              .bid
		output wire [1:0]  hps_1_h2f_lw_axi_master_bresp,                                       //                                                              .bresp
		output wire        hps_1_h2f_lw_axi_master_bvalid,                                      //                                                              .bvalid
		input  wire        hps_1_h2f_lw_axi_master_bready,                                      //                                                              .bready
		input  wire [11:0] hps_1_h2f_lw_axi_master_arid,                                        //                                                              .arid
		input  wire [20:0] hps_1_h2f_lw_axi_master_araddr,                                      //                                                              .araddr
		input  wire [3:0]  hps_1_h2f_lw_axi_master_arlen,                                       //                                                              .arlen
		input  wire [2:0]  hps_1_h2f_lw_axi_master_arsize,                                      //                                                              .arsize
		input  wire [1:0]  hps_1_h2f_lw_axi_master_arburst,                                     //                                                              .arburst
		input  wire [1:0]  hps_1_h2f_lw_axi_master_arlock,                                      //                                                              .arlock
		input  wire [3:0]  hps_1_h2f_lw_axi_master_arcache,                                     //                                                              .arcache
		input  wire [2:0]  hps_1_h2f_lw_axi_master_arprot,                                      //                                                              .arprot
		input  wire        hps_1_h2f_lw_axi_master_arvalid,                                     //                                                              .arvalid
		output wire        hps_1_h2f_lw_axi_master_arready,                                     //                                                              .arready
		output wire [11:0] hps_1_h2f_lw_axi_master_rid,                                         //                                                              .rid
		output wire [31:0] hps_1_h2f_lw_axi_master_rdata,                                       //                                                              .rdata
		output wire [1:0]  hps_1_h2f_lw_axi_master_rresp,                                       //                                                              .rresp
		output wire        hps_1_h2f_lw_axi_master_rlast,                                       //                                                              .rlast
		output wire        hps_1_h2f_lw_axi_master_rvalid,                                      //                                                              .rvalid
		input  wire        hps_1_h2f_lw_axi_master_rready,                                      //                                                              .rready
		input  wire        clk_0_clk_clk,                                                       //                                                     clk_0_clk.clk
		input  wire        hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset, // hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset.reset
	...
	wire          rsp_mux_src_valid;                                    // rsp_mux:src_valid -> hps_1_h2f_lw_axi_master_agent:write_rp_valid
	wire  [111:0] rsp_mux_src_data;                                     // rsp_mux:src_data -> hps_1_h2f_lw_axi_master_agent:write_rp_data
	wire          rsp_mux_src_ready;                                    // hps_1_h2f_lw_axi_master_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                  // rsp_mux:src_channel -> hps_1_h2f_lw_axi_master_agent:write_rp_channel
	wire          rsp_mux_src_startofpacket;                            // rsp_mux:src_startofpacket -> hps_1_h2f_lw_axi_master_agent:write_rp_startofpacket
	wire          rsp_mux_src_endofpacket;                              // rsp_mux:src_endofpacket -> hps_1_h2f_lw_axi_master_agent:write_rp_endofpacket
	wire          rsp_mux_001_src_valid;                                // rsp_mux_001:src_valid -> hps_1_h2f_lw_axi_master_agent:read_rp_valid
	wire  [111:0] rsp_mux_001_src_data;                                 // rsp_mux_001:src_data -> hps_1_h2f_lw_axi_master_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                                // hps_1_h2f_lw_axi_master_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                              // rsp_mux_001:src_channel -> hps_1_h2f_lw_axi_master_agent:read_rp_channel
	wire          rsp_mux_001_src_startofpacket;                        // rsp_mux_001:src_startofpacket -> hps_1_h2f_lw_axi_master_agent:read_rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                          // rsp_mux_001:src_endofpacket -> hps_1_h2f_lw_axi_master_agent:read_rp_endofpacket
	...
	wire          hps_1_h2f_lw_axi_master_agent_write_cp_valid;         // hps_1_h2f_lw_axi_master_agent:write_cp_valid -> router:sink_valid
	wire  [111:0] hps_1_h2f_lw_axi_master_agent_write_cp_data;          // hps_1_h2f_lw_axi_master_agent:write_cp_data -> router:sink_data
	wire          hps_1_h2f_lw_axi_master_agent_write_cp_ready;         // router:sink_ready -> hps_1_h2f_lw_axi_master_agent:write_cp_ready
	wire          hps_1_h2f_lw_axi_master_agent_write_cp_startofpacket; // hps_1_h2f_lw_axi_master_agent:write_cp_startofpacket -> router:sink_startofpacket
	wire          hps_1_h2f_lw_axi_master_agent_write_cp_endofpacket;   // hps_1_h2f_lw_axi_master_agent:write_cp_endofpacket -> router:sink_endofpacket
	...
	wire          hps_1_h2f_lw_axi_master_agent_read_cp_valid;          // hps_1_h2f_lw_axi_master_agent:read_cp_valid -> router_001:sink_valid
	wire  [111:0] hps_1_h2f_lw_axi_master_agent_read_cp_data;           // hps_1_h2f_lw_axi_master_agent:read_cp_data -> router_001:sink_data
	wire          hps_1_h2f_lw_axi_master_agent_read_cp_ready;          // router_001:sink_ready -> hps_1_h2f_lw_axi_master_agent:read_cp_ready
	wire          hps_1_h2f_lw_axi_master_agent_read_cp_startofpacket;  // hps_1_h2f_lw_axi_master_agent:read_cp_startofpacket -> router_001:sink_startofpacket
	wire          hps_1_h2f_lw_axi_master_agent_read_cp_endofpacket;    // hps_1_h2f_lw_axi_master_agent:read_cp_endofpacket -> router_001:sink_endofpacket
	...
	altera_merlin_axi_master_ni #(
		...
		.ST_CHANNEL_W              (2),
		.ID                        (0)
	) hps_1_h2f_lw_axi_master_agent (
		.aclk                   (clk_0_clk_clk),                                                        //              clk.clk
		.aresetn                (~hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //        clk_reset.reset_n
		.write_cp_valid         (hps_1_h2f_lw_axi_master_agent_write_cp_valid),                         //         write_cp.valid
		.write_cp_data          (hps_1_h2f_lw_axi_master_agent_write_cp_data),                          //                 .data
		.write_cp_startofpacket (hps_1_h2f_lw_axi_master_agent_write_cp_startofpacket),                 //                 .startofpacket
		.write_cp_endofpacket   (hps_1_h2f_lw_axi_master_agent_write_cp_endofpacket),                   //                 .endofpacket
		.write_cp_ready         (hps_1_h2f_lw_axi_master_agent_write_cp_ready),                         //                 .ready
		...
		.read_cp_valid          (hps_1_h2f_lw_axi_master_agent_read_cp_valid),                          //          read_cp.valid
		.read_cp_data           (hps_1_h2f_lw_axi_master_agent_read_cp_data),                           //                 .data
		.read_cp_startofpacket  (hps_1_h2f_lw_axi_master_agent_read_cp_startofpacket),                  //                 .startofpacket
		.read_cp_endofpacket    (hps_1_h2f_lw_axi_master_agent_read_cp_endofpacket),                    //                 .endofpacket
		.read_cp_ready          (hps_1_h2f_lw_axi_master_agent_read_cp_ready),                          //                 .ready
		...
		.awid                   (hps_1_h2f_lw_axi_master_awid),                                         // altera_axi_slave.awid
		.awaddr                 (hps_1_h2f_lw_axi_master_awaddr),                                       //                 .awaddr
		.awlen                  (hps_1_h2f_lw_axi_master_awlen),                                        //                 .awlen
		.awsize                 (hps_1_h2f_lw_axi_master_awsize),                                       //                 .awsize
		.awburst                (hps_1_h2f_lw_axi_master_awburst),                                      //                 .awburst
		.awlock                 (hps_1_h2f_lw_axi_master_awlock),                                       //                 .awlock
		.awcache                (hps_1_h2f_lw_axi_master_awcache),                                      //                 .awcache
		.awprot                 (hps_1_h2f_lw_axi_master_awprot),                                       //                 .awprot
		.awvalid                (hps_1_h2f_lw_axi_master_awvalid),                                      //                 .awvalid
		.awready                (hps_1_h2f_lw_axi_master_awready),                                      //                 .awready
		.wid                    (hps_1_h2f_lw_axi_master_wid),                                          //                 .wid
		.wdata                  (hps_1_h2f_lw_axi_master_wdata),                                        //                 .wdata
		.wstrb                  (hps_1_h2f_lw_axi_master_wstrb),                                        //                 .wstrb
		.wlast                  (hps_1_h2f_lw_axi_master_wlast),                                        //                 .wlast
		.wvalid                 (hps_1_h2f_lw_axi_master_wvalid),                                       //                 .wvalid
		.wready                 (hps_1_h2f_lw_axi_master_wready),                                       //                 .wready
		.bid                    (hps_1_h2f_lw_axi_master_bid),                                          //                 .bid
		.bresp                  (hps_1_h2f_lw_axi_master_bresp),                                        //                 .bresp
		.bvalid                 (hps_1_h2f_lw_axi_master_bvalid),                                       //                 .bvalid
		.bready                 (hps_1_h2f_lw_axi_master_bready),                                       //                 .bready
		.arid                   (hps_1_h2f_lw_axi_master_arid),                                         //                 .arid
		.araddr                 (hps_1_h2f_lw_axi_master_araddr),                                       //                 .araddr
		.arlen                  (hps_1_h2f_lw_axi_master_arlen),                                        //                 .arlen
		.arsize                 (hps_1_h2f_lw_axi_master_arsize),                                       //                 .arsize
		.arburst                (hps_1_h2f_lw_axi_master_arburst),                                      //                 .arburst
		.arlock                 (hps_1_h2f_lw_axi_master_arlock),                                       //                 .arlock
		.arcache                (hps_1_h2f_lw_axi_master_arcache),                                      //                 .arcache
		.arprot                 (hps_1_h2f_lw_axi_master_arprot),                                       //                 .arprot
		.arvalid                (hps_1_h2f_lw_axi_master_arvalid),                                      //                 .arvalid
		.arready                (hps_1_h2f_lw_axi_master_arready),                                      //                 .arready
		.rid                    (hps_1_h2f_lw_axi_master_rid),                                          //                 .rid
		.rdata                  (hps_1_h2f_lw_axi_master_rdata),                                        //                 .rdata
		.rresp                  (hps_1_h2f_lw_axi_master_rresp),                                        //                 .rresp
		.rlast                  (hps_1_h2f_lw_axi_master_rlast),                                        //                 .rlast
		.rvalid                 (hps_1_h2f_lw_axi_master_rvalid),                                       //                 .rvalid
		.rready                 (hps_1_h2f_lw_axi_master_rready),                                       //                 .rready
	...
	pio_mm_interconnect_0_router router (
		.sink_ready         (hps_1_h2f_lw_axi_master_agent_write_cp_ready),                        //      sink.ready
		.sink_valid         (hps_1_h2f_lw_axi_master_agent_write_cp_valid),                        //          .valid
		.sink_data          (hps_1_h2f_lw_axi_master_agent_write_cp_data),                         //          .data
		.sink_startofpacket (hps_1_h2f_lw_axi_master_agent_write_cp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (hps_1_h2f_lw_axi_master_agent_write_cp_endofpacket),                  //          .endofpacket
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_router router_001 (
		.sink_ready         (hps_1_h2f_lw_axi_master_agent_read_cp_ready),                         //      sink.ready
		.sink_valid         (hps_1_h2f_lw_axi_master_agent_read_cp_valid),                         //          .valid
		.sink_data          (hps_1_h2f_lw_axi_master_agent_read_cp_data),                          //          .data
		.sink_startofpacket (hps_1_h2f_lw_axi_master_agent_read_cp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (hps_1_h2f_lw_axi_master_agent_read_cp_endofpacket),                   //          .endofpacket
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_router_002 router_002 (
	...
	pio_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_1_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pio_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
